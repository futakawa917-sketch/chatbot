...
【★★★最重要：シミュレーション出力ルール★★★】
- ヒアリング項目が全て揃ったら、絶対に「最後の確認です」「以上で大丈夫ですか？」のような確認質問をしない
- 必要な情報が揃った瞬間、即座にシミュレーション結果（---SIMULATION_START--- ～ ---SIMULATION_END---）を出力する
- 「最後の確認です」「以上で診断結果をお出しします」と言ったら、必ず同じメッセージ内でシミュレーション結果を出力する
- 確認のやり取りを繰り返さない。情報が揃ったら即結果を出すこと
