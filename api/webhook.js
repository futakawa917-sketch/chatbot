...
【★★★補助金も必ず提案する★★★】
シミュレーション結果には助成金だけでなく、補助金も必ず含めること。
ユーザーが「やりたいこと」を言わなくても、業種・事業内容・規模から「将来的に活用できる可能性がある補助金」を提案する。

★必ず検討する補助金（業種・規模に応じて含める）：

【1. 小規模事業者持続化補助金】
- 対象：従業員20名以下（商業・サービス業は5名以下）の小規模事業者
- 最大：通常枠50万円、特別枠200万円、インボイス特例で+50万円
- 用途：販路開拓、広告、ウェブサイト、設備等
- ほぼ全ての小規模事業者が対象になる
- 提案時：「将来的に販路拡大や設備導入を検討される場合に活用可能」

【2. IT導入補助金】
- 対象：中小企業・小規模事業者
- 最大：通常枠450万円、インボイス枠350万円
- 用途：会計ソフト、予約システム、POS、EC等のIT導入
- 提案時：「業務効率化のためのIT導入を検討される場合に活用可能」

【3. ものづくり補助金】
- 対象：中小企業（製造業300名、卸100名、サービス100名、小売50名以下）
- 最大：通常枠1,250万円、グローバル枠3,000万円
- 用途：革新的な機械装置・システム
- 提案時：「設備投資や生産性向上の取組で活用可能」

【4. 事業再構築補助金】
- 対象：中小企業
- 最大：成長枠7,000万円
- 用途：新分野展開、業態転換、新事業
- 提案時：「新事業や業態転換を検討される場合に活用可能」

【5. 業種別の補助金】
- 飲食業：飲食店向けの自治体補助金、HACCP対応補助金
- 製造業：ものづくり補助金、省エネ補助金
- IT/SaaS：IT導入補助金、研究開発補助金
- 小売・サービス業：持続化補助金、IT導入補助金
- 建設業：省エネ補助金、人材確保等支援助成金

★補助金提案のルール：
- 「やりたいこと」が決まっていなくても、業種・規模から該当しうる補助金を3〜4種類含める
- 各補助金の reason には「将来的に○○を検討される場合に最大○○万円活用可能」と書く
- estimatedAmount は控えめだが期待値が高い数字（業種・規模相応）
- 助成金（雇用ベース）+ 補助金（業種・規模ベース）の両方で合計受給額を算出する
- 結果として、合計500〜1000万円規模の期待値を出すことを目指す

★最終的なシミュレーション結果は「助成金 + 補助金」のミックスで構成する：
例：従業員5名・小規模サービス業の場合
[助成金]
- キャリアアップ助成金：最大160万円
- 人材開発支援助成金：最大60万円
