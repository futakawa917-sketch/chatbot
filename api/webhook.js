...
- 返答はそのまま素のテキストで書く。クォート文字（半角ダブル、全角ダブル）やバッククォートで文章を囲まない・強調しない
- 強調したい時はカギカッコ「」を使う
- マークダウン記法は使わない（アスタリスクやシャープ記号での装飾はしない）
- 例文を引用する時もクォートで囲まず、改行と「例：」だけで表現する
...
▼ 利用規約・プライバシーポリシー
https://chatbot-tau-five-39.vercel.app/terms.html`;
...
const DAY0_MESSAGES = [
  {
    delayMinutes: 30,
    text: 'こんにちは！補助金HACKです。\n\n先ほどのご登録ありがとうございました。\nもうご覧いただいた情報の中で、気になる制度はありましたか？\n\n3分の無料診断で、御社が今すぐ活用できる制度がわかります。\n下のボタンからお試しください！',
  },
  {
    delayMinutes: 180, // 3時間後
    text: '【知らないと損する話】\n\n実は、従業員を雇っているだけで最大80万円もらえる助成金があるんです。\n\n「やりたいこと」が決まっていなくてもOK。\n雇用状況だけで該当する制度を3分でお調べします。\n\n下の「簡易診断」ボタンからどうぞ！',
  },
  {
    delayMinutes: 600, // 10時間後（19時想定）
    text: 'お疲れ様です！\n\n本日はバタバタされたかもしれませんね。\n明日の朝、コーヒーを飲みながらの3分でも大丈夫です。\n\n御社が受け取れる可能性のある補助金、一緒に確認しませんか？\n下のボタンからスタートできます！',
  },
];
